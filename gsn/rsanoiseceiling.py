...
from gsn.constructnearestpsdcovariance import constructnearestpsdcovariance
import scipy.stats as stats
from scipy.spatial.distance import pdist

def rsanoiseceiling(data,
    ...
    mnD, cD, shrinklevelD, nllD = calcshrunkencovariance(data=np.mean(data,2).T,
                                                         shrinklevels=shrinklevels,
                                                         wantfull=1)
    ...
    if mode == 0:
        ...
        cSb, _ = constructnearestpsdcovariance(cSb * sc)   # impose scaling and run it through constructnearestpsdcovariance.m for good measure
    elif mode == 1:
        pass
