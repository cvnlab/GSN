    ...
    if 'fullbasis' in results and 'mags' in results:
       ...
       # Plot 5: Cross-validation results (first subplot in middle row)
        ...
        if test_data is None:
            ...
            train_avg_denoised = (train_avg_demeaned.T @ results['denoiser']).T + results['unit_means']
            test_avg_denoised = (test_avg_demeaned.T @ results['denoiser']).T + results['unit_means']
